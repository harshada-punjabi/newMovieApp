...
import 'package:newfluttermovieapp/presentation/utils/themes.dart';
...
class _AppStateContainerState extends State<AppStateContainer> {
  ...
  initState() {
    ...
    SharedPreferences.getInstance().then((sharedPref) {
      setState(() {
        themeCode = sharedPref.getInt(StaticStrings.SHARED_PREF_KEY_THEME) ??
  ...
  updateTheme(int themeCode) {
    ...
    SharedPreferences.getInstance().then((sharedPref) {
      sharedPref.setInt(StaticStrings.SHARED_PREF_KEY_THEME, themeCode);
    });
  }
